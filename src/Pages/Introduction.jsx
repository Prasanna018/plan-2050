...
transportation-planning/financial-planning-fiscal-constraint'>regulations-and-guidance</a>
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center"
                    ...
                    <div>
                        <span className='text-white font-semibold text-xl p-4'>Madison Bus Rapid Transit
                            (2019) </span>
                        <p className='p-3'>
                            The City of Madison is working to implement
                            a Bus Rapid Transit (BRT) system (Metro
                            Rapid) as part of an efort to improve its existing transit system and reduce travel times
                    ...
                    <div>
                        <span className='text-white font-semibold text-xl p-4'>Metro Transit Network Redesign (Anticipated
                    ...
                    <div>
                        <span className='text-white font-semibold text-xl p-4'>Public Participation Plan (2021)
                            (2019) </span>
                        <p className='p-3'>
                    ...
                    <div className='p-4 text-orange-700 font-bold'>
                        <span className='text-2xl'>STATE DOT PLANS AND STUDIES  </span>
                    </div>

                    <div>
                        <span className='text-white font-semibold text-xl p-4'>Connect 2050 (2022)
                    ...
                    <div>
                        ...
                        <span className='text-white font-semibold text-xl p-4'>Wisconsin State Freight Plan (2018)
