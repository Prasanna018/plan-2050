                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center " id="1">
                    ...
                    <div className='p-3'>
                        ...
                        <p className='p-4 '>
                            ...
                            Black Lives Matter movement and nationwide reckoning with systemic and institutional
                            racism – sparked in part by the killing of
                            George Floyd in a Minneapolis bicycle lane
                            by a uniformed police ofcer – prompted
                            1
                            Urban Institute (2020). Access to Opportunity through
                            <a href='n, https://www.urban.org/
research/publication/access-opportunity-throughequitable-transportation/view/full_report '
                                target='_blank' className='text-blue-600 underline'>
                                n, https://www.urban.org/
                                research/publication/access-opportunity-throughequitable-transportation/view/full_report
                            </a>

                            a necessary re-focusing in the planning
                            ...
                            Ethics2
                            is explicit that planners must work to
                            ...
                            access and transit dependence. When saferat-home orders were issued in March 2020,
                            ...
                            ridership declined markedly with safer-athome orders, yet decreased the least in
                            areas with the largest populations of transitdependent riders – primarily people of color
                            and those with low incomes.3
                            For residents of these areas, the combined
                            impacts of spatially segregated land use
                            policies; transit service optimized for white2 https://www.planning.org/ethics/ethicscode/
                            3
                            Metro Transit Network Redesign Choices Report, https://
                            www.cityofmadison.com/metro/documents/networkredesign/ExistingConditionsChoicesReport-20210311.pdf
                            (pages 11-12)
                            ...
                            4
                            See the MPO’s Pedestrian and Bicycle Facility
                            ...
                            immigration/states-ofering-driver-s-licenses-toimmigrants.aspx
                            May 2022 | 4-3
                            process, the MPO and CARPC analyzed
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center " id="3">
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center " id="4">
