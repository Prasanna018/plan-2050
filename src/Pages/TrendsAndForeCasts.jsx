        ...
        >
            ...
            <div className="w-full relative sm:w-full sm:h-fit pt-32 sm:pt-0 overflow-y-auto no-scrollbar md:w-full lg:h-full">
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="2">
                    ...
                    <div className="space-y-4 flex flex-col justify-center items-center p-2">
                    ...
                    <div>
                        <p className="p-4">Figure 2-c details the projected change in households
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="4">
                    ...
                    <div className="p-2">
                        ...
                        <div className="lg:flex lg:flex-row flex-col py-4">
                            <img
                                className="p-2"
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="5">
                    ...
                    <div className="flex flex-col space-y-4 lg:flex-row gap-x-2 w-full justify-evenly pt-4">
                    ...
                    <div className="flex lg:flex-row flex-col justify-center items-center w-full p-2">
                        <img
