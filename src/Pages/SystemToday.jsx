...
function SystemToday() {
    ...
    return (
        ...
        >
            ...
            {/* right */}
            <div className="w-full relative sm:w-full sm:h-fit pt-32 sm:pt-0 overflow-y-auto no-scrollbar md:w-full lg:h-full p-2">
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="1">
                    ...
                    <div className='flex lg:flex-row flex-col items-center p-4'>
                        <p>
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="5">
                    <div className='p-4
                    '>
                    ...
                    <div>
                        <span className='p-2 text-orange-700 text-xl'>
                            Park and Ride Lots
                    ...
                    <div className='p-2'>
                        <span className='p-4 text-orange-700 text-xl'>YW Transit JobRide Program</span>
                        <p className='p-2'>
                    ...
                    <div className='p-2'>
                        <span className='p-4 text-orange-700 text-xl'>Bike Share</span>
                        <p className='p-2'>
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="6">


                    <div>
                        <span className='p-4 text-white text-2xl '>Inter-Regional Travel </span>
                    ...
                    <div>
                        ...
                        <span className='p-2 text-orange-700 textx-xl' >INTER-CITY BUS SERVICE</span>
                        <p className='p-4'>
                ...
                <div className="p-6 text-white sm:text-xl text-sm md:text-white scroll-section flex flex-col items-center" id="7">
                    <div>
                        <span className='p-4 text-white text-2xl' >
                    ...
                    <div className='p-4 '>
                        ...
                        <p className='p-2'>The metropolitan area is home to numerous
